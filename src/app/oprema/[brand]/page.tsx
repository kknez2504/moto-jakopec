...
export default function OpremaBrend({ params }: Props) {
  const brand: Brand | undefined = (allBrands.oprema ?? []).find(
  ...
  const products = allProducts.filter(
    p => p.category === "Oprema" && p.brand === params.brand
  );
